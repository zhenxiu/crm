...
<div style="text-align:right; padding:6px 6px 0 0;">
	...
	<% if (page.hasPreviousPage()){%>
		<a href='?page=0&sortType=${sortType}&${searchParams}&${condition}'>首页</a>
		&nbsp;&nbsp;
	...
	<% if (page.hasNextPage()){%>
		...
		&nbsp;&nbsp;
		<a href='?page=${page.totalPages - 1}&sortType=${sortType}&${searchParams}&${condition}'>末页</a>
		&nbsp;&nbsp;
	<%}%>
