...
<html>
  ...
  <form:form id="chance" action="${ctx}/chance/dispatch/${chance.id}" method="post" 
  	...
  	<input type="hidden" name="status" value="2"/>
		...
		<table class="query_form_table" border="0" cellPadding="3" cellSpacing="0">				
			<tr>					
				<th>指派给</th>
				<td>
					<form:select path="designee.id" items="${users}" 
								itemLabel="name" itemValue="id"></form:select>
					<span class="red_star">*</span>
				</td>
				<th>指派时间</th>
				<td>
					<form:input path="designeeDate" readonly="readonly"/>
					<span class="red_star">*</span>
				</td>
			</tr>
		</table>
