...
public class CustomerService extends IdEntity {
	...
	public String toString() {
		return "CustomerService [serviceType=" + serviceType
				+ ", serviceTitle=" + serviceTitle + ", customer=" + customer
				+ ", serviceState=" + serviceState + ", serviceRequest="
				+ serviceRequest + ", createdby=" + createdby + ", createDate="
				+ createDate + ", allotTo=" + allotTo + ", allotDate="
				+ allotDate + ", serviceDeal=" + serviceDeal + ", dealDate="
				+ dealDate + ", dealResult=" + dealResult + ", satisfy="
				+ satisfy + "]";
	}
